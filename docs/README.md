...
- Start with `project/overview.md` for product intent and current repository context.
- Use `project/requirements.md` as the canonical MVP specification.
- Use `project/architecture.md` for target system structure and operational constraints.
- Use `adr/` for durable architecture and process decisions.
...
- Update `README.md` only with high-level repository information; keep detailed internal context here.
