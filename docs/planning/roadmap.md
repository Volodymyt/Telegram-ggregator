...
- Execute the `M0 Foundations Ready` milestone to replace the legacy runtime baseline with the canonical package, config/login contract, storage bootstrap, and operability foundations. Active epic: [M0 Foundations Ready](active/m0_01_foundations_ready/epic.md).
